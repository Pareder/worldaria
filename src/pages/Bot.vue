<template>
  <div>
    ...
    <OnlineModal v-if="loaded && game.count === geojson.length" :score="game.score" :nickname="'You'" :enemy="'Bot'" :colors="sideColors" @makeRevenge="revenge" />
    ...
    makeBotTurn () {
      setTimeout(() => {
        ...
        if (chance < this.chance) {
          this.layers.find(item => item.feature.properties.name === this.subjects[this.game.count]).setStyle({ fillColor: this.sideColors.enemy }).off('click')
