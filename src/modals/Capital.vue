  ...
  <div class="modal-outer">
    ...
    <div class="modal">
      <div class="modal-content" :class="end ? 'end' : 'start'">
        ...
        <div class="capitals">
          <button class="btn" v-for="(capital, id) in capitals" :class="capital.isAnswered === 'right' ? 'right' : capital.isAnswered === 'wrong' ? 'wrong' : ''" :key="id" @click="answer(id)" :disabled="end">{{ capital.name }}</button>
        </div>
      </div>
    </div>
  </div>
