    ...
    <div class="modal">
      <div class="modal-content">
        <div class="status">
          ...
          You have been invited to game in mode <span class="mode__name">{{ type | capitalize }}</span> <span class="population">population: {{ modeName }}</span> by <span class="opponentColor">{{ opponent }}</span>
        </div>
      </div>
      <div class="buttons">
